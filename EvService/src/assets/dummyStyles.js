...
export const heroStyles = {
  container: "relative w-screen lg:h-screen h-full bg-black overflow-hidden flex items-center justify-center",
...
export const homeCarsStyles = {
  ...
  premiumBadge: "inline-flex items-center px-4 py-2 rounded-full bg-gray-800/50 backdrop-blur-sm border border-gray-700 ",
  ...
  bookButton: "metal-btn active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-sky-300 cursor-pointer",
